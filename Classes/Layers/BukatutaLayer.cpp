...
void BukatutaLayer::onNodeLoaded(Node * pNode, cocosbuilder::NodeLoader * pNodeLoader)
{
    pImage = (Sprite*) pNode->getChildByTag(100);
}


cocos2d::SEL_MenuHandler BukatutaLayer::onResolveCCBCCMenuItemSelector(Ref * pTarget, const char* pSelectorName)
{
    return NULL;
}
