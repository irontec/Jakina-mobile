...
class BukatutaLayer : public Layer, public cocosbuilder::CCBSelectorResolver, public cocosbuilder::NodeLoaderListener
{
public:
    ...
    //virtual void onNodeLoaded(Node * pNode, CCNodeLoader * pNodeLoader);
