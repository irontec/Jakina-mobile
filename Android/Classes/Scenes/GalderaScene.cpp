...
{    
    ...
    galdera = CCLabelTTF::create("Esto hay que poner para que cocos calcule el tamaño de la pregunta. Nunca sale. Pero es importante saber que puede variar dependiendo de para quien se haga el producto. hasta .", "font/CarterOne.ttf", 16.0);
    ...
    galdera->setDimensions(CCSizeMake(VisibleRect::getVisibleRect().size.width - 20, 100));
    ...
    CCLabelTTF *pLabel1 = CCLabelTTF::create("", "fonts/PT_Sans-Web-Regular.ttf", 12.0);
    ...
    pErantzuna1->setPreferredSize(CCSizeMake(220, 56));
    ...
    CCLabelTTF *pLabel2 = CCLabelTTF::create("", "fonts/PT_Sans-Web-Regular.ttf", 12.0);
    ...
    pErantzuna2->setPreferredSize(CCSizeMake(220, 56));
    ...
    CCLabelTTF *pLabel3 = CCLabelTTF::create("", "fonts/PT_Sans-Web-Regular.ttf", 12.0);
    ...
    pErantzuna3->setPreferredSize(CCSizeMake(220, 56));
