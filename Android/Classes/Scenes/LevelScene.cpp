...
bool LevelScene::init()
{
    ...
    pScrollLayer = new CCScrollLayer();
    ...
    pScrollLayer->moveToPage(round(numPages / 4));
    pBglayer->addChild(pScrollLayer);
    
    addChild(pBglayer);
    this->schedule( schedule_selector(LevelScene::moveToFirst), 0.5f );
	return true;
}

void LevelScene::moveToFirst()
{
