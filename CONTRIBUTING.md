...
[search the issue tracker](https://github.com/irontec/Jakina-mobile/issues?q=something)
to see if someone else has already created a ticket.
If not, go ahead and [make one](https://github.com/irontec/Jakina-mobile/issues/new)!
...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/irontec/Jakina-mobile/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/irontec/Jakina-mobile/issues/new). 
